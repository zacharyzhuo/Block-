...
// GET /verifyApplicationPass 
router.get('/', checkLogin, function (req, res, next) {
    queryStuInfo().then((result) => {
        res.render('manager/verifyApplicationPass', { stuLists: result })
    })
})

// GET /writeVerifyResult 
router.post('/', checkLogin, async function (req, res, next) {
    let passArr = req.fields.result
    console.log(passArr)
    ...
    try {
        ...
        return res.redirect('/manager/verifyApplicationPass')
    }
    console.log("================ next ====================")
