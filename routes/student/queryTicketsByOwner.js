...
router.get('/', checkLogin, async function (req, res, next) {
    ...
    // console.log("333333%%%%%%%%%%%%%%%%%%%%%%%%")
    // console.log(querySuccessApplyStatusFalse.onIssue)
    // if(querySuccessApplyStatusFalse.onIssue = 1) {
    //     return res.status(400).json({ status: "error", message: "系統處理中 請稍後查詢" });
    // }
    ...
    var arr = [ticketArr, usedTicketNum]
